...
public class MemberServiceImpl implements MemberService {
  ...
  private MemberMapper mapper;
        ...
        @Override
        public String idView(Map<String, String> map) {
          // TODO Auto-generated method stub
          return mapper.idView(map);
        }

        @Override
        public int passwdFind(Map<String, String> map) {
          // TODO Auto-generated method stub
          return mapper.passwdFind(map);
        }

        @Override
        public String passwdView(Map<String, String> map) {
          // TODO Auto-generated method stub
          return mapper.passwdView(map);
        }
