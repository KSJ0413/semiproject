...
public class Utility {
        ...
        /*
         * public static int rcount(int contentsno, ReplyMapper rmapper) { return
         * rmapper.rcount(contentsno); }
         */
    
        public static String rpaging1(int total, int nowPage, int recordPerPage, String col, String word, String url,int nPage) {
