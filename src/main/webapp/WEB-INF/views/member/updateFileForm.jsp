...
<html>
<head>
 <script src="/js/updateFile.js" type="text/javascript"></script>
  ...
  <form   id="updateFileEX" class="form-horizontal" 
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">          
        ...
        name="fnameMF" accept=".jpg,.png,.gif" required="required" width="200px" height="200px">
      </div>
    </div>
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-8">
        <button type="button" class="btn btn-default" id="checkForm">수정</button>
